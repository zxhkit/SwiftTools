...
class JJZoomViewController: JJBaseViewController ,JXSegmentedViewDelegate{
    ...
    override func viewDidLayoutSubviews() {
        ...
        pagingView.frame = CGRect(x: 0, y: CGFloat(kNavBarHeight), width: self.view.bounds.size.width, height: self.view.bounds.size.height)
    }
...
extension JJZoomViewController: JXPagingViewDelegate {
...
extension JJZoomViewController: JXPagingMainTableViewGestureDelegate {
